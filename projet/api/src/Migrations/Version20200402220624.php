...
final class Version20200402220624 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE resolution (id INT AUTO_INCREMENT NOT NULL, meeting_id INT DEFAULT NULL, type_vote ENUM(\'Simple\', \'Absolue\', \'Double\', \'Unanimité\'), title VARCHAR(60) NOT NULL, uuid VARCHAR(255) NOT NULL, INDEX IDX_FDD30F8A67433D9C (meeting_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
