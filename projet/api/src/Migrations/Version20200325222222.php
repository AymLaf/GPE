...
final class Version20200325222222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, syndic_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, role VARCHAR(30) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(50) DEFAULT NULL, phone_number VARCHAR(255) DEFAULT NULL, verification_id VARCHAR(255) DEFAULT NULL, verified SMALLINT DEFAULT NULL, hash VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D6497E3C61F9 (owner_id), UNIQUE INDEX UNIQ_8D93D649F0654A02 (syndic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
