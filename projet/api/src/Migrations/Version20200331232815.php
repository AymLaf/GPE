 ...
 */
final class Version20200331232815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE building (id INT AUTO_INCREMENT NOT NULL, syndic_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, number INT NOT NULL, city VARCHAR(255) NOT NULL, complement VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(10) NOT NULL, INDEX IDX_E16F61D4F0654A02 (syndic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE delegation (id INT AUTO_INCREMENT NOT NULL, meeting_id INT DEFAULT NULL, donor_owner_id INT DEFAULT NULL, receiver_owner_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, INDEX IDX_292F436D67433D9C (meeting_id), UNIQUE INDEX UNIQ_292F436D2B4FCEE4 (donor_owner_id), UNIQUE INDEX UNIQ_292F436D46999A0C (receiver_owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE meeting (id INT AUTO_INCREMENT NOT NULL, building_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, date DATETIME NOT NULL, file_name VARCHAR(255) NOT NULL, guest_link VARCHAR(255) NOT NULL, live SMALLINT NOT NULL, INDEX IDX_F515E1394D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE owner (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(255) NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, tantieme NUMERIC(4, 1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE resolution (id INT AUTO_INCREMENT NOT NULL, meeting_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, type_vote ENUM(\'Simple\', \'Absolue\', \'Double\', \'Unanimité\'), title VARCHAR(60) NOT NULL, INDEX IDX_FDD30F8A67433D9C (meeting_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE syndic (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, syndic_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, role VARCHAR(30) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(255) DEFAULT NULL, verification_id VARCHAR(255) DEFAULT NULL, verified SMALLINT DEFAULT NULL, hash VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D6497E3C61F9 (owner_id), UNIQUE INDEX UNIQ_8D93D649F0654A02 (syndic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, resolution_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, result ENUM(\'Pour\', \'Contre\', \'Neutre\'), INDEX IDX_5A1085647E3C61F9 (owner_id), INDEX IDX_5A10856412A1C43A (resolution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
