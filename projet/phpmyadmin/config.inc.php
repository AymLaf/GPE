...
if (isset($_ENV['PMA_THEME'])) {
	$cfg['ThemeDefault'] = trim($_ENV['PMA_THEME']);
}

if (isset($_ENV['PMA_COOKIE_LOGIN_VALIDITY'])) {
	$cfg['LoginCookieValidity'] = trim($_ENV['PMA_COOKIE_LOGIN_VALIDITY']);
}
